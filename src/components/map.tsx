                ...
                >
                    ...
                    <div className="absolute z-10 bottom-0 left-0 right-0 p-2 space-y-2
                        ...
                        <div className="flex gap-2 justify-end items-end">
                            ...
                            <button
                                className="bg-white hover:bg-blue-600 text-black p-2 rounded-lg transition-all duration-200 shadow-md flex items-center justify-center w-12 h-12"
                        ...
                        <div className="flex gap-2">
                            ...
                            {onBack && (
                                <button
                                    className="bg-white hover:bg-white text-black p-2 rounded-lg transition-all duration-200 shadow-md flex items-center justify-center w-12 h-12"
