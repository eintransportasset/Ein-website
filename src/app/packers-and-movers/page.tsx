        ...
        <div className="bg-white backdrop-blur-sm shadow-2xl shadow-slate-200/50 rounded-2xl p-6 sm:p-8 border border-slate-200/50 ">
          ...
          {showMap && (
            <div className="fixed inset-0 bg-black/5 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl h-[75vh] relative overflow-hidden border border-slate-200">
                <div className="absolute top-1 left-2 p-1 z-10">
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-1 shadow-lg border border-slate-200">
                    <p className="text-xs font-semibold text-slate-700 flex items-center gap-2">
                      <MapPin className="w-2 h-2 text-[#0086FF]" />
                ...
                <button
                  className="absolute top-4 right-12 z-10 p-3 bg-white/95 backdrop-blur-sm text-slate-600 hover:text-red-500 rounded-xl shadow-lg transition-all duration-300 hover:scale-105 border border-slate-200"
