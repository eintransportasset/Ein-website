...
//             <div className="text-center bg-[#F0F0F0] shadow-[0_4px_20px_rgba(0,0,0,0.1)] rounded-lg p-6 sm:p-8">
...
//               </p>
//               <Link  href="/packers-and-movers" className="bg-blue-600 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
...
//               </p>
//               <Link href="/goods-transport"  className="bg-blue-600 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
//                 Start Shipping
...
//                 <li><Link href="/packers-and-movers" className="hover:text-white">Packers & Movers</Link></li>
//                 <li><Link href="goods-transport" className="hover:text-white">Trucks Service</Link></li>
//                 <li><Link href="/packers-and-movers" className="hover:text-white">Local Moving</Link></li>
//                 <li><Link href="/packers-and-movers" className="hover:text-white">Long Distance Moving</Link></li>
//                 <li><Link href="/packers-and-movers" className="hover:text-white">Commercial Moving</Link></li>
//               </ul>
//             </div>
//             <div>
...
//                     <Phone width={15} />
//                   </span>
//                   <Link className="hover:text-white" href="tel:+919043384332">+91 9043384332</Link>
//                 </section>
//                 <section className="flex gap-2 items-center">
//                   <span className="bg-[#1E2939] rounded-[12px] px-2 py-1 text-white">
//                     <Mail width={15} />
...
//                   <Link className="hover:text-white" href="mailto:eintransport.booking@gmail.com">eintransport.booking@gmail.com
//                   </Link>
//                 </section>
...
//       {/* Header */}
//       <header
//         className={`bg-[#F0F0F0] text-white py-4 px-4 sm:px-6 sticky top-0 z-50 backdrop-blur-sm transition-all duration-500 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`}
//       >
//         <div className="container mx-auto flex justify-between items-center">
...
//             <Link
//               href="#services"
//               className="text-gray-700 hover:text-[#0086FF] transition-colors duration-300 font-medium"
//             >
//               Services
//             </Link>
//             <Link
...
//       {/* Hero Section */}
//       <section className="bg-gradient-to-br from-gray-50 to-blue-50 py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden">
//         <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-transparent"></div>
//         <div
//           className={`container mx-auto text-center max-w-5xl relative z-10 transition-all duration-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
//         >
//           <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
//             <span className="inline-block animate-fade-in-up">{"Where's it going?"}</span>
//             <br />
//             <span className="inline-block animate-fade-in-up animation-delay-200">{"We'll take it there."}</span>
//           </h1>
//           <p className="text-3xl sm:text-4xl md:text-5xl text-blue-700 font-bold mb-8 animate-fade-in-up animation-delay-400">
//             Fast, Safe, and Hassle-Free.
//           </p>
//           <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
//             Professional moving services you can trust. Get your free quote today.
//           </p>

//           <div
//             className={`flex flex-col items-center space-y-8 transition-all duration-1000 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
//           >
//             <div className="bg-[#d8edff] px-6 py-3 rounded-full text-gray-700 font-semibold text-lg hover:scale-105 transition-transform duration-300">
//               Packers & Movers
//             </div>
...
//               <input
//                 placeholder="Pickup Location"
//                 className="flex-1 p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 text-lg hover:border-blue-300"
//               />
//               <input
//                 placeholder="Drop Location"
//                 className="flex-1 p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 text-lg hover:border-blue-300"
...
//             <button className="group flex items-center px-8 py-4 bg-[#0086FF] text-white rounded-xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl text-lg font-semibold">
//               <ArrowBigRight className="h-6 w-6 mr-3 group-hover:translate-x-1 transition-transform duration-300" />
//               Let's Move
//             </button>
//           </div>
//         </div>
...
//         <div className="absolute bottom-20 right-10 w-32 h-32 bg-blue-300 rounded-full opacity-15 animate-float animation-delay-1000"></div>
//       </section>
...
//                       </div>
//                       <div className="min-w-0">
//                         <h4 className="font-bold text-lg text-gray-800 break-words">{testimonial.name}</h4>
//                         <p className="text-blue-600 font-medium break-words">{testimonial.role}</p>
//                       </div>
//                     </div>
...
//       {/* Enhanced Footer */}
//       <footer id="contact" className="bg-gray-900 text-white py-12 sm:py-16 px-4 sm:px-6">
//         <div className="container mx-auto max-w-7xl">
...
//                   { name: "Trucks Service", href: "/goods-transport" },
            ...
            <div className="space-y-4">
              ...
              {/* <div className="relative">
                <input
                  ...
                  className="w-full p-4 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-500"
                />
...
// Refrence code 
    //   <section className="bg-gradient-to-br from-gray-50 to-blue-100 py-20 sm:py-28 px-4 sm:px-6 relative overflow-hidden">
    //   <div className="absolute inset-0 opacity-50">
    //     {/* Subtle background pattern */}
    //     <div className="absolute inset-0 bg-[url('/path-to-your-subtle-pattern.svg')] bg-repeat"></div>
    //   </div>
    ...
    //         className="bg-white p-8 rounded-2xl shadow-2xl"
    //       >
    //         <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Get a Free Quote</h2>
    //         <div className="space-y-4">
    //           <div className="relative">
    //             <input
    //               placeholder="Pickup Location"
    ...
    // </section>
      ...
      //     <div className="mb-6">
      //       <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl font-bold text-gray-900 leading-tight">
      //         <span className="inline-block animate-fade-in-up">Where's it going?</span>

      //         <span className="inline-block animate-fade-in-up animation-delay-300">We'll take it there.</span>
      //       </h1>
      //     </div>

      //     {/* Animated Tagline with Typewriter Effect */}
      //     {/* <div className="mb-8 h-16 sm:h-20 flex items-center justify-center">
      //       <p className="text-3xl sm:text-4xl md:text-5xl font-bold animate-fade-in-up animation-delay-600">
      //         <span className="inline-block  text-blue-700 animate-slide-in-left animation-delay-800">{words[currentWordIndex]}</span>
      //         <span className=" ml-4 animate-fade-in-up animation-delay-1000">, and Hassle-Free.</span>
      //       </p>
      //     </div> */}
      //     {/* <TrueFocus
      //       sentence="Fast, Safe and Hassle-Free."
      //       manualMode={false}
      //       blurAmount={5}
      //       borderColor="red"
      //       animationDuration={1}
      ...
      //     <RotatingText
      //       texts={["Fast",  "Hassle-Free", "Safe"]}
      //       mainClassName=" mx-auto sm:px-2 w-fit md:px-3 text-7xl font-bold bg-[#0086FF] text-white overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
      //       staggerFrom={"last"}
      //       initial={{ y: "100%" }}
      //       animate={{ y: 0 }}
      //       exit={{ y: "-120%" }}
      ...
      //     {/* Subtitle */}
      //     <p className="text-lg mt-5 sm:text-xl text-gray-600 mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-1200">
      //       Professional moving services you can trust. Get your free quote today.
      //     </p>
      //     {/* <div className="absolute top-3.5 left-0 w-full h-full overflow-hidden">
      //       <div className="absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-blue-300/30 to-transparent animate-slide-right"></div>
      //       <div className="absolute bottom-1/4 right-0 w-full h-px bg-gradient-to-l from-transparent via-blue-300/30 to-transparent animate-slide-left"></div>
      //     </div> */}

      //     {/* Enhanced Form Section */}
      //     <div
      //       className={`flex flex-col items-center  transition-all duration-1000 delay-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
      //     >
      //       {/* Service Badge with Pulse Animation */}
      //       <div className="bg-[#d8edff] px-6 py-3 rounded text-gray-700 font-semibold text-lg hover:scale-105 transition-all duration-300 animate-pulse-slow animate-fade-in-up animation-delay-1400">
      //         Packers & Movers
      //       </div>

      //       {/* Enhanced Form Inputs */}
      //       <div className="flex flex-col sm:flex-row  w-full max-w-3xl">
      //         <div className="flex-1 animate-slide-in-left animation-delay-1600">
      //           <input
      //             placeholder="Pickup Location"
      //             className="w-full p-4 border-2 border-gray-200  focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 text-lg hover:border-blue-300 hover:shadow-sm transform "
      //           />
      //         </div>
      //         <div className="flex-1 animate-slide-in-right animation-delay-1800">
      //           <input
      //             placeholder="Drop Location"
      //             className="w-full p-4 border-2 border-gray-200  focus:outline-none focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 text-lg hover:border-blue-300 hover:shadow-sm transform"
      //           />
      //         </div>
      //       </div>

      //       {/* Enhanced CTA Button */}
      //       <div className="mt-6 animate-bounce-in animation-delay-2000">
      //         <button className="group relative flex items-center px-8 py-4 bg-[#0086FF] text-white rounded-xl hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl text-lg font-semibold overflow-hidden">
      ...
      //           {/* Button Content */}
      //           <ArrowBigRight className="relative z-10 h-6 w-6 mr-3 group-hover:translate-x-2 transition-transform duration-300" />
      //           <span className="relative z-10">Let's Move</span>
